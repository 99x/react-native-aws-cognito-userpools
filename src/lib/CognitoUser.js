...
//Adding these lines to support react-native
...
export default class CognitoUser {
        ...
        respondToAuthChallenge(
          ...
          (errAuthenticate, dataAuthenticate) => {
            ...
            if (challengeName === 'NEW_PASSWORD_REQUIRED') {
              ...
              return callback.newPasswordRequired(
                userAttributes,
                requiredAttributes
              );
            }
  ...
  */
  ...
  getSession(callback) {
    ...
    const keyPrefix = `CognitoIdentityServiceProvider.${this.pool.getClientId()}.${this
      .username}`;
